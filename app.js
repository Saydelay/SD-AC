...
async function refresh(){
 ...
 view.forEach(s=>{
  ...
  row.innerHTML='<div class="song-art">♪</div><div class="song-info"><div class="song-title"></div><div class="song-sub"></div></div><div class="song-actions"><button class="fav">♡</button><button class="play-song">▶</button></div><div class="song-actions"><button class="delete">×</button></div>';
...
async function play(i){
 ...
 audio.play();$('#bottomPlayer').classList.add('show');updatePlayer();
}
...
function stop(){audio.pause();audio.removeAttribute('src');if(url)URL.revokeObjectURL(url);url=null;current=-1;$('#bottomPlayer').classList.remove('show');$('#progress').value=0}
function next(){
